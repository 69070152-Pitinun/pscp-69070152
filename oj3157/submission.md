...
```text
โจทย์ให้ค่าเริ่มต้นของคะแนนคือ 0 โดยจะให้รับค่า n มันเป็นจำนวนตัวที่จะรับค่ามา(รับเป็นสัญลักษณ์ ) โดยสัญลักษณ์ + จะเพิ่มทีละ 10 และ - จะลดทีละ 5
Input:รับค่า n เป็นจำนวนตัวของสัญลักษณ์
Output:พิมพ์ค่า score สุดท้ายออกมา
Constraints:ค่าเริ่มต้นคือ 0
```
...
```text
Step 1: กำหนดให้ score เริ่มต้นเป็น 0
Step 2: รับค่า n มาเป็น input ที่ไว้บอกจำนวนค่าที่รับมา
Step 3: ตรวจสอบค่าที่รับมา หากเป็น สัญลักษณ์ + ให้เพิ่มค่า score ที่ละ 10
หากเป็นสัญลักษณ์ - ให้ลด scoreทีละ 5
Step 4: พิมพ์ค่า score ออกมา
```
...
```text
วิธีสุดท้ายของฉันเหมือนกันแผนแรก โดยกำหนดให้ score เริ่มต้นเป็น 0 จากนั้นรับสัญลักษณ์มา n จำนวน หากสัญลักษณ์เป็น + ให้เพิ่มค่า score ทีละ 10 หากเป็น - ให้ลดทีละ 5 และพิมพ์ค่า score สุดท้ายออกมา
```
...
```text
ตรวจสอบว่าหากมีแต่สัญลักษณ์ + อย่างเดียว ค่าจะออกมาถูกต้องไหม
```
...
```text
ตรวจสอบว่าโค้ดสามารถรันได้อย่างถูกต้องหรือไม่
```
