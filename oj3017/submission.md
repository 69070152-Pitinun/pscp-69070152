...
```text
โจทย์ให้คำนวณเงินรวมค่าบริการและภาษีมูลค่าเพิ่มทั้งหมดที่ลูกค้าจะต้องจ่าย โดยรับคำนวณจากเงินต้นของราคาอาหารและเครื่องดื่มที่ลูกค้าได้สั่งไป

Input:
จำนวนเงินค่าอาหารและเครื่องดื่มที่ได้สั่งไป

Output:
จำนวนเงินที่รวมค่าบริการและภาษีมูลค่าเพิ่มแล้ว

Constraints:
ในโจทย์มีข้อกำหนดคือจะต้องคิดค่าบริการอย่างน้อย 50 บาทและต้องไม่เกิน 1000 บาท และการคิดภาษีมูลค่าเพิ่มให้คิดจากเงินต้นรวมกับค่าบริการแล้ว
```
...
```text
Step 1: รับค่า input มาเป็นเงินค่าอาหารและเครื่องดื่ม
Step 2: นำค่าเงินในขั้นที่ 1 ไปคูณกับ 0.1 ( คิดค่าบริการ )
Step 3: คิดภาษีมูลค่าเพิ่มจากการนำค่าอาหารและค่าบริการรวมกันแล้วคูณด้วย 0.07
Step 4: สร้างตัวแปรเก็บค่าอาหาร ค่าบริการและภาษีมูลค่าเพิ่มรวมกัน แล้วส่งค่าออกมา
```
...
```text
วิธีสุดท้ายของฉันเหมือนกับแผนแรก แต่เพิ่มเงื่อนไขเข้ามา แผนคือรับค่าเงินต้นเข้ามาแล้วนำไปคิดค่าบริการ โดยเพิ่มเงื่อนไขเข้ามาคือ ถ้าค่าบริการที่คำนวณออกมาน้อยกว่า 50 ให้คิดค่าบริการเท่ากับ 50 เลย และอีกเงื่อนไขคือถ้าค่าบริการที่คำนวณออกมามากกว่า 1000 ให้คิดค่าบริการเท่ากับ 1000 จากนั้นจึงค่อยค่าเงินต้นรวมกับค่าบริการไปคำนวณกับภาษีมูลค่าเพิ่ม ก่อนจะรวมค่าเงินทั้งหมดและพิมพ์ออกไป

หลังจากคิดแผนแรกออกมาแล้ว ฉันยังติดปัญหาในเรื่องการสร้างเงื่อนไข จึงได้ขอคำใบ้จาก Gemini ในเรื่องเงื่อนไขเกี่ยวกับค่าบริการมา
```
...
```text
กรณีคิดค่าบริการออกมาได้น้อยกว่า 50 เพราะจะได้เช็คว่าเงื่อนไขที่ตั้งไว้ว่าหากค่าบริการน้อยกว่า 50 ให้คิดค่าบริการ 50 สามารถรันโปรแกรมได้อย่างถูกต้องมั้ย
```
...
```text
กรณีคิดค่าบริการออกมาได้มากกว่า 1000 เพราะจะได้เช็คว่าเงื่อนไขที่ตั้งไว้ว่าหากค่าบริการมากกว่า 1000 ให้คิดค่าบริการ 1000 สามารถรันโปรแกรมได้อย่างถูกต้องมั้ย
```
...
```text
กรณีที่ใส่ค่าเงินต้นเป็น 0 เพราะหากไม่มีค่าอาหารเลย ควรจะส่งค่าผลลัพธ์ออกมาเป็น 0
```
