...
| Item | Answer |
|---|---|
| OJ problem number/title | OJ3232 - [LEARNING LOGS] กบน้อยกระโดด |
| OJ submission ID, if submitted | 650135 |
| OJ status | Pass |
...
```text
ฉันขอให้ AI ช่วยให้คำใบ้เกี่ยวกับเงื่อนไขของโจทย์ ว่าควรจะเริ่มสร้างเงื่อนไขและสร้างลูปอย่างไรจึงจะเหมาะสม
```
...
```text
AI ช่วยให้ฉันได้สังเกตว่าควรใช้ while loop อย่างไรและทำให้ฉันได้สังเกตการทำงานของ break
```
...
```text
ฉันได้แก้ไขปัญหาในเรื่องของ pep8 และการรับค่า input แบบใช้ map ทำให้สะดวกมากขึ้น
```
...
```text
ฉันได้เรียนรู้การใช้ while loop ในการสร้างเงื่อนไข
```
