...
```text
โจทย์ให้หาค่าเฉลี่ยของความเข้มสีแต่ละช่องโดย input คือ ค่า RGB ของสีตั้งต้น 2 สี ส่วน output คือ ตัวเลขผลลัพธ์ ข้อจำกัดอาจจะต้องระวังในเรื่องของข้อความอื่นปะปน
```
...
```text
Step 1 : รับค่า input 2 บรรทัดโดยใช้ map เข้ามาช่วย แยกค่า r , g , b
Step 2 : คำนวณค่าเฉลี่ยของค่า r ของ 2 ค่าที่รับมา
Step 3 : คำนวณค่าเฉลี่ยของค่า g ของ 2 ค่าที่รับมา
Step 4 : คำนวณค่าเฉลี่ยของค่า b ของ 2 ค่าที่รับมา
Step 5 : พิมพ์ค่า r g b ออกมาตามลำดับแบบเว้นช่องว่าง
```
...
```text
เหมือนกับแผนแรก รับค่า input โดยใช้ map จากนั้นแยกคำนวณค่าเฉลี่ยทีละตัวก่อนจะพิมพ์ออกมา
```
...
```text
ผสมสีเดิม เช็คว่าได้ค่าเดิมมั้ย
```
