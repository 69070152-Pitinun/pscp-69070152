...
```text
โจทย์ให้นับสระจากข้อความที่รับมา ซึ่งก็คือ a,e,i,o,u 
...
Constraints:
สระที่จะนับ ตัวเล็กและตัวใหญ่ถือเป็นตัวเดียวกัน
```
...
```text
step 1: รับข้อความมาและแปลงเป็นตัวเล็กทั้งหมด
step 2: สร้างตัวแปรไว้เก็บจำนวนของสระด้วยใช้ count
step 3: สร้างเงื่อนไขโดยที่ถ้าจำนวนสระที่นับได้มีมากกว่า 0 ให้แสดงผลออกมาว่ามีสระทั้งหมดกี่ตัว
```
...
```text
วิธีสุดท้ายของฉันเหมือนกับแผนแรกคือรับข้อความมาและแปลงเป็นตัวเล็ก สร้างตัวแปรไว้นับว่ามีจำนวนสระกี่ตัว นำไปเช็คในเงื่อนไขหากจำนวนสระมี 1 ตัวขึ้นไปให้พิมพ์ออกมาว่ามีกี่ตัว
```
...
```text
กรณีที่มีทั้งสระตัวใหญ่และตัวเล็ก เพื่อเช็คว่าสามารถนับทั้งสองแบบเป็นตัวเดียวกัน
```
...
```text
กรณีที่ไม่มีสระเลย เพื่อเช็คว่าจะมีการส่งค่าออกมามั้ย
```
...
```text
กรณีที่มีเพียงสระตัวใหญ่เพียงอย่างเดียว เพื่อเช็คว่าสามารถนับได้อย่างถูกต้องไหม
```
