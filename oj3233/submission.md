...
```text
โจทย์ให้รับค่าสลาก ซึ่งประกอบไปด้วยตัวอักษร 1 ตัวและตัวเลขอีก 5 หลัก ถ้าหมายเลขและตัวอักษรตรงกับหมายเลขที่ออก 5 หลักจะได้เงิน 1 ล้านบาท , หมายเลขตรงแต่ตัวอักษรไม่ตรงได้ 1 แสนบาท , ถูก 2 ตัวท้ายและตัวอักษรตรงได้ 1 พัน , ถูก 3 ตัวท้ายและตัวอักษรตรงได้ 2 พัน , ถูก 2 ตัวท้ายแต่ตัวอักษรไม่ตรงได้ 1 ร้อย , ถูก 3 ตัวท้ายแต่ตัวอักษรไม่ตรงได้ 2 ร้อย , ถ้าตรงแค่ตัวอักษรได้ 20 บาท ถ้าไม่ตรงกับเงื่อนไขอะไรเลยได้ 0 บาท

Input : บรรทัดแรกเป็นผลสลากที่ออก
บรรทัดที่สองเป็นสลากที่เราซื้อ

Output : เงินรางวัล

Constraints : เนื่องจากเงื่อนไขที่มีมาก จึงควรจะเรียงให้ถูกเพื่อป้องกันการสับสนเงื่อนไข
```
...
```text
Step 1 : รับค่า input เป็นผลสลากที่ออก (โดยรับแบบแยกตัวอักษรกับตัวเลข)
Step 2 : รับค่า input อีกบรรทัดเป็นสลากที่เราซื้อ
Step 3 : สร้างเงื่อนไขว่าหากตัวอักษรและหมายเลขทั้ง 5 หลักตรงให้พิมพ์ 1000000
Step 4 : สร้างเงื่อนไขว่าหากตัวอักษรไม่ตรงแต่หมายเลขทั้ง 5 หลักตรงให้พิมพ์ 100000
Step 5 : สร้างเงื่อนไขว่าหากตัวอักษรตรงและถูกเลขท้าย 3 ตัว ให้พิมพ์ 2000
Step 6 : สร้างเงื่อนไขว่าหากตัวอักษรตรงและถูกเลขท้าย 2 ตัว ให้พิมพ์ 1000
Step 7 : สร้างเงื่อนไขว่าหากตัวอักษรไม่ตรงแต่ถูกเลขท้าย 3 ตัว ให้พิมพ์ 200
Step 8 : สร้างเงื่อนไขว่าหากตัวอักษรไม่ตรงแต่ถูกเลขท้าย 2 ตัว ให้พิมพ์ 100
Step 9 : สร้างเงื่อนไขว่าหากถูกแค่ตัวอักษรให้พิมพ์ 20
Step 10 : หากไม่เข้าเงื่อนไขใดเลยพิมพ์ 0
```
...
```text
วิธีสุดท้ายของฉันใกล้เคียงกับแผนแรก โดยปรับเปลี่ยนลักษณะการเขียนโค้ดเล็กน้อยเนื่องจากกรณีที่มีมากทำให้โค้ดค่อนข้างยาว จึงกำหนดให้มีตัวแปรเก็บค่า ที่หมายเลขที่ออกตรงกับหมายเลขที่เราซื้อ แล้วจึงนำมาเข้าเงื่อนไข
```
...
```text
เช็คกรณีรางวัลใหญ่สุด : เช็คว่าตัวอักษรและหมายเลขทุกหลักตรงกันกับสลากที่ออกหรือไม่
```
...
```text
เช็คกรณีถูกแค่ตัวอักษร : เช็คว่าตัวอักษรตรงและสามารถรันได้อย่างถูกต้อง
```
...
```text
เช็คกรณีที่ไม่เข้าเงื่อนไขเลย : เช็คว่าเงินรางวัลที่ออกมาจะเท่ากับ 0 หรือไม่
```
