...
```text
โจทย์ให้รับค่าอุณหภูมิจากหน่วยหนึ่งเปลี่ยนเป็นอีกหน่วยหนึ่ง

Input:
ค่าอุณหภูมิเป็นจำนวนจริง
หน่วยของค่าอุณหภูมิของบรรทัดแรก
หน่วยอุณหภูมิที่ต้องการเปลี่ยน

Output:
ค่าอุณภูมิที่ถูกเปลี่ยนเป็นหน่วยที่ต้องการ

Constraint:
รับค่า input เป็นจำนวนจริงควรระวังในเรื่องของเลขทศนิยมที่อาจจะคลาดเคลื่อน
```
...
```text
Step 1 : รับค่า input เป็นค่าอุณหภูมิ หน่วย และหน่วยที่ต้องการเปลี่ยนตามลำดับ
Step 2 : เช็คว่าหน่วยที่ต้องการเปลี่ยนเป็นหน่วยเดียวกับที่รับค่ามามั้ย หากทั้งสองหน่วยเป็นหน่วยเดียวกัน ให้ตอบค่าอุณหภูมิเดิม
Step 3 : เช็คกรณีถัดไปหน่วยหนึ่งเป็น อีกหน่วยหนึ่ง ใช้สูตรคำนวณตามที่โจทย์ให้มา แล้วเก็บไว้ในตัวแปรเช็คไปจนครบทุกกรณี
Step 4 : พิมพ์ค่าอุณหภูมิที่คำนวณแล้วและถูกเก็บในตัวแปรออกมา
```
...
```text
วิธีสุดท้ายของฉันเหมือนกับแผนแรก เพียงแต่ปรับสูตรการคำนวณในบางจุดเนื่องจากในสูตรนั้นมีการคำนวณเศษส่วนคลาดเคลื่อน หลังจากได้ใช้เอไอเพื่อตรวจทานโค้ดและได้คำแนะนำมาว่าควรจะคำนวณค่าเศษส่วนบางตัวให้เป็นทศนิยมคงที่
```
...
```text
กรณีที่หน่วยทั้งสองเหมือนกัน เพื่อตรวจทานว่าพิมพ์ค่าเดิมออกมาถูกต้องหรือไม่
```
...
```text
กรณีที่เปลี่ยนจาก F เป็น R เนื่องจากเป็นกรณีที่ใช้นำค่าเศษส่วนมาแปลงเป็นทศนิยมแบบคงที่เพื่อการคำนวณไม่คลาดเคลื่อน
```
...
```text
กรณีที่เปลี่ยนจาก R เป็น F เนื่องจากเป็นกรณีที่ใช้นำค่าเศษส่วนมาแปลงเป็นทศนิยมแบบคงที่เพื่อการคำนวณไม่คลาดเคลื่อน
```
