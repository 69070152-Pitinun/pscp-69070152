...
```text
โจทย์ให้เขียนโปรแกรมแสดงฤดูกาล โดยมี 4 ฤดูกาล เดือนที่ 1,2,3 เป็นฤดูหนาว เดือนที่ 4,5,6 เป็นฤดูใบไม้ผลิ เดือนที่ 7,8,9 เป็นฤดูร้อน เดือนที่ 10,11,12 เป็นฤดูใบไม้ร่วง
...
Constraints:
ฤดูกาลจะเปลี่ยนทุกวันที่ 21 ของเดือนที่ 3 หารลงตัว กล่าวคือเดือน 3,6,9,12
...
```text
step 1: รับค่า input เป็นเดือนและวัน
step 2: สร้าง list ของแต่ละฤดูกาลเก็บค่าเดือนแต่ละเดือนไว้
step 3: นำค่า input มาเช็คเงื่อนไขพิเศษที่ว่าฤดูกาลจะเปลี่ยนไปทุกวันที่ 21 และเป็นเดือนที่หาร 3 ลงตัว
step 4: ถ้าจริง ให้พิมพ์ ฤดูกาลถัดจากเดือนนั้น 
step 5: ถ้าไม่จริง ให้พิมพ์ฤดูกาลของเดือนนั้น ๆ
step 6: ทำตาม step 3-5 สร้างเงื่อนไขแบบนี้ทุกฤดูกาล
```
...
```text
วิธีสุดท้ายของฉันเหมือนกับแผนแรก คือรับค่า input มาแล้วเช็คเงื่อนไขพิเศษก่อนว่า เป็นวันที่ 21 เป็นต้นไปและเดือนสามารถหารด้วย 3 ได้หรือไม่ หากใช่ให้แสดงฤดูกาลที่เปลี่ยนไป แต่ถ้าให้แสดงฤดูกาลของเดือนนั้น ๆ
```
...
```text
เพื่อเช็คกรณีปกติที่ไม่ใช่เงื่อนไขพิเศษ
```
...
```text
เพื่อเช็คกรณีที่เดือนหาร 3 ลงตัวแต่วันที่น้อยกว่า 21
```
...
```text
เพื่อเช็คกรณีที่เดือนหาร 3 ลงตัวและวันที่มากกว่า 21
```
