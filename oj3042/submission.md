...
```text
โจทย์ให้รับค่าจำนวนเต็มบวกหนึ่งตัวแล้วให้หาว่าตั้งแต่จำนวนนั้นจนถึง 0 มีเลขอะไรบ้างที่หาร 10 ลงตัวและให้แสดงเลขพวกนั้นออกมา

Input:
จำนวนเต็มบวก 1 ตัว (N)

Output:
จำนวนเต็มบวกตั้งแต่ N จนถึง 0 ที่สามารถหารด้วย 10 ได้

Contraints:
ค่าจำนวนเต็มบวกที่รับมาอาจจะเป็นเลขที่ไม่ได้หาร 10 ลงตัวในทันที ต้องหาวิธีลดจำนวนนั้นออกจนกว่าจะหาร 10 ได้
```
...
```text
Step 1 : รับค่าจำนวนเต็มมา
Step 2 : สร้าง while loop โดยจะทำงานต่อไป เมื่อค่าจำนวนเต็มนั้นยังมากกว่าเท่ากับ 0 
Step 3 : หากค่าที่รับมาโมลดูลัส 10 ไม่เหลือเศษ ให้แสดงค่านั้น และลดที 10 ไปเรื่อย ๆ จนกว่าจะถึงศูนย์
Step 4 : แต่ถ้าเงื่อนไขใน step 3 เป็นเท็จให้นำค่าที่รับมาไปลบ 1 ออกจนกว่า ค่าด้งกล่าวจะหาร 10 ได้และสามารถรัน step 3 ได้
```
...
```text
วิธีสุดท้ายของฉันเหมือนแผนแรก โดยรับค่าจำนวนเต็มมาจากนั้นนำไปเข้า while loop และเช็คเงื่อนไขที่ว่าหากหาร 10 แล้วไม่เหลือเศษให้แสดงค่านั้นและลบออกทีละ 10 จนกว่าจะเหลือ 0 แต่หากไม่เข้าเงื่อนไขดังกล่าวจะลบออกทีละ 1 จนกว่าจะสามารถหาร 10 ได้
```
...
```text
เช็คค่าที่ หาร 10 ไม่ลงตัวตั้งแต่ค่าแรก
```
...
```text
เช็คค่าว่าหากมีแค่ 10 ตัวเดียวจะแสดงผลตัวเดิมจนถึงศูนย์ได้อย่างถูกต้องไหม
```
...
```text
เช็คค่าว่าหากมีแค่ 0 ตัวเดียวสามารถแสดงผลได้อย่างถูกต้องไหม
```
