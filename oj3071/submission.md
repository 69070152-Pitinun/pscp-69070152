...
```text
โจทย์ให้เราคำนวณจำนวนตัวเลขที่อยู่ในช่วงระหว่าง A จนถึง B ที่สามารถหารด้วย d แล้วเหลือเศษ r
...
Output:
จำนวนตัวเลขที่อยู่ในช่วง A ถึง B โดยที่หาร d แล้วเหลือเศษ r

Constraints:
ค่า B มากกว่า A และค่า r น้อยกว่า d
```
...
```text
step1:รับค่าเข้ามา 4 ตัวตามลำดับ
step2:สร้างตัวแปรไว้นับจำนวนเลขที่สามารถดำเนินการได้
step3:ใช้ for loop โดยเริ่มจาก A จนถึง B
step4:สร้างเงื่อนไขว่าหากเลขที่อยู่ในช่วงดังกล่าวสามารถโมลดูลัสกับ d แล้วได้เศษให้นำตัวแปรที่สร้างไว้เพื่อนับจำนวน บวกเพิ่มทีละหนึ่ง
step5:พิมพ์ค่าตัวแปรที่นับจำนวนไว้
```
...
```text
วิธีสุดท้ายของฉันเหมือนแผนแรกคือรับค่าตัวเข้ามาแล้วสร้างตัวแปรไว้นับจำนวนเลขที่โจทย์ต้องการ จากนั้นสร้าง for loop เพื่อกำหนดช่วงของตัวแปรแล้วนำไปเข้าเงื่อนไข ถ้าเงื่อนไขเป็นจริงให้บวกเพิ่มค่าตัวแปรที่เอาไว้นับ แล้วจึงพิมพ์ออกมา
```
...
```text
case ปกติ เพื่อเช็คว่าโค้ดสามารถทำงานได้อย่างถูกต้อง
```
...
```text
case ที่ไม่มีคำตอบใดเลย เช็คว่าจะส่งคืนค่าเป็นศูนย์หรือไม่
```
...
```text
case ปกติ เพื่อเช็คว่าโค้ดสามารถทำงานได้อย่างถูกต้องแม้ตัวเลขจะเพิ่มมากขึ้น
```
