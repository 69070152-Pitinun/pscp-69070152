...
```text
โจทย์ให้รับข้อความมา แล้วให้ส่ง output ออกมาเป็นข้อความเดิมที่ถูกนำไปเรียงจากข้างหลังมาข้างหน้าเป็นตัวพิมพ์เล็ก

Input: ข้อความ

Output: ข้อความแบบเรียงจากข้างหลังมาข้างหน้าตัวพิมพ์เล็ก

Constraints : ข้อความที่ออกมาต้องเป็นตัวพิมพ์เล็กเท่านั้น
```
...
```text
Step 1: รับตัวแปรรับค่าข้อความ (รับค่ามาเป็น string)
Step 2: เข้าถึง index ของ string และใช้ [::-1] กำหนดระยะก้าวจากทางข้างหลังไปข้างหน้า
Step 3: ใช้ฟังก์ชัน .lower() ในการทำให้ตัวอักษรทั้งหมดเป็นตัวพิมพ์เล็ก
Step 4:  print ค่า output ส่งออกไป
...
```text
วิธีสุดท้ายของฉันเหมือนกับแผนแรก ฉันใช้การเข้าถึง index ของ string ในการทำให้ตัวอักษรเรียงจากข้างหลังไปข้างหน้า และใช้ฟังก์ชัน .lower() ในการทำให้ตัวอักษรทั้งหมดเป็นพิมพ์เล็ก
```
...
```text
เลือกกรณีที่ข้อความเป็นตัวใหญ่ทั้งหมดเพื่อเช็คว่าสามารถส่ง output ออกมาเป็นตัวเล็กได้อย่างถูกต้องมั้ย
```
...
```text
เลือกกรณีที่ข้อความเป็นตัวใหญ่บางตัวเพื่อเช็คว่าสามารถส่ง output ออกมาเป็นตัวเล็กได้อย่างถูกต้องมั้ย
```
...
```text
เลือกกรณีที่ข้อความมีอักขระพิเศษบางตัวเพื่อเช็คว่าสามารถส่ง output ออกมาเป็นตัวเล็กได้อย่างถูกต้องมั้ย
```
