...
```text
โจทย์อยากรู้ว่าดอกไม้ต้นสุดท้ายถูกปลูกอยู่ในแถบที่เท่าไหร่โดยรับค่าเข้ามา 2 ตัวคือ L (ความหนา) และ N (จำนวนดอกไม้ทั้งหมด)
```
...
```text
Step 1 : รับค่า input เป็นความหนาและจำนวนดอกไม้
Step 2 : ตั้งค่าตัวแปรเริ่มต้นให้แถบเป็น 0 , ค่ารวมเป็น 0 (เก็บดอกไม้ทั้งหมด)
Step 3 : ใช้ while วนลูป โดยจะทำงานต่อไปเมื่อค่ารวมมากกว่าจำนวนดอกไม้
Step 4 : เมื่อผลรวมทั้งหมดมากกว่าเท่ากับจำนวนดอกไม้ให้พิมพ์ค่าแถบล่าสุดออกมา
```
...
```text
เหมือนแผนแรก รับค่าความหนาแถบกับจำนวนดอกไม้เข้ามา เข้าลูปแล้วบวกสะสมไปเรื่อย ๆ จนกว่าจะครบ แล้วค่อยพิมพ์หมายเลขแถบออกมา
```
...
```text
เช็คว่าทำงานได้อย่างถูกต้องหรือไม่
```
