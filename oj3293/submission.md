...
```text
โจทย์ทำกรอบ * ล้อมรอบข้อความโดยกรอบจะอิงตามความยาวของข้อความที่ยาวที่สุด และเว้นช่องว่างซ้ายขวาก่อนจะเติม *
```
...
```text
Step1 : รับข้อความ 5 บรรทัด
Step2 : หาข้อความที่ยาวที่สุดไว้สร้างกรอบด้านกว้าง (max)
Step3 : พิมพ์กรอบปิดหัวท้าย
Step4 : เว้นวรรคซ้ายข้าวก่อนปิดกรอบ
Step 5 : เติมช่องว่างให้กับข้อความที่เหลือก่อนปิด
```
...
```text
เหมือนแผนแรกรับค่า input มาเก็บแล้วเช็คความยาวสูงสุดเพื่อสร้สงกรอบ พิมพ์กรอบบนล่าง แล้วทำข้อความแต่ละบรรทัดมาเติมช่องว่างก่อนสร้างกรอบหน้าหลัง
```
...
```text
เช็คว่าสร้างกรอบได้อย่างถูกต้องไหม
```
...
```text
ชี้ให้เห็นว่าโค้ดตรงหล่นอะไรไป
```

คุณยังทำอะไรด้วยตนเอง

```text
เพิ่มช่องว่างหน้าหลังระหว่างตัวอักษรและกรอบ
```
